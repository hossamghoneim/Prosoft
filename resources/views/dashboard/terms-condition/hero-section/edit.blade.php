...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.terms-condition-hero-sections.update', $termsConditionHeroSection->id) }}" class="form submitted-form" method="post"
                id="submitted-form" data-redirection-url="{{ route('dashboard.terms-condition-hero-sections.index') }}">
                @csrf
                @method('PUT')

                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Edit terms condition hero') . ' : ' . $termsConditionHeroSection->description }}</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    <div class="row my-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control form-control form-control" name="description" id="description_inp"
                                data-kt-autosize="true">{{ $termsConditionHeroSection->description }}</textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="date" class="form-control" id="effective_date_inp" name="effective_date"
                                    placeholder="example" value="{{ $termsConditionHeroSection->effective_date->format('Y-m-d') }}" />
