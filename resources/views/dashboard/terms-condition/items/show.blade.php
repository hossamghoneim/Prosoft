    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <div class="card-header d-flex align-items-center">
                <h3 class="fw-bolder text-dark">{{ __('terms condition item data') . ' : ' . $termsConditionItem->title }}</h3>
            </div>
            <!-- end   :: Card header -->
                ...
                <div class="row my-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="title_inp" name="title"
                                placeholder="example" value="{{ $termsConditionItem->title }}" readonly />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="number" class="form-control" id="order_inp" name="order"
                                placeholder="example" value="{{ $termsConditionItem->order }}" readonly />
                    ...
                    <div class="col-md-12 fv-row">
                        ...
                        <textarea class="form-control form-control form-control" name="description" id="description_inp"
                            data-kt-autosize="true" readonly>{{ $termsConditionItem->description }}</textarea>
            ...
            <div class="form-footer">
                ...
                <!-- begin :: Submit btn -->
                <a href="{{ route('dashboard.terms-condition-items.index') }}" class="btn btn-primary">
