...
@section('content')
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        {{ __('Edit about us final section') }}
                    </li>
                    <!-- end   :: Item -->
                </ul>
                <!-- end   :: Breadcrumb -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.about-us-final-sections.update', $aboutUsFinalSection->id) }}" class="form submitted-form" method="post"
                ...
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Edit about us final section') . ' : ' . $aboutUsFinalSection->title }}</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    <div class="row my-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title"
                                    placeholder="example" value="{{ $aboutUsFinalSection->title }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control form-control form-control" name="description" id="description_inp"
                                data-kt-autosize="true">{{ $aboutUsFinalSection->description }}</textarea>
