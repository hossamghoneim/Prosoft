    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('About Us Middle Section Items') }}</h1>
                <!-- end   :: Title -->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        {{ __('About us middle section items list') }}
                    </li>
                    <!-- end   :: Item -->
                </ul>
                <!-- end   :: Breadcrumb -->
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    @if(!$canAddMore)
                        <button class="btn btn-secondary" disabled data-bs-toggle="tooltip"
                            title="You cannot add more items because all about us middle sections have reached the limit of 3 items">
                    ...
                    @else
                        <a href="{{ route('dashboard.about-us-middle-section-items.create') }}" class="btn btn-primary" data-bs-toggle="tooltip"
                            title="">
            ...
            <table data-ordering="false" id="kt_datatable" class="table text-center table-row-dashed fs-6 gy-5">
                ...
                <thead>
                    <tr class="text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th>{{ __('Order') }}</th>
                        <th>{{ __('About Us Middle Section') }}</th>
                        <th>{{ __('is active') }}</th>
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/about_us_middle_section_items.js') }}"></script>
@endpush
