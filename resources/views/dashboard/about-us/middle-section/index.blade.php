    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('About Us Middle Section') }}</h1>
                <!-- end   :: Title -->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        {{ __('About us middle section list') }}
                    </li>
                    <!-- end   :: Item -->
                </ul>
                <!-- end   :: Breadcrumb -->
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    @if($existingSection)
                        <button class="btn btn-secondary" disabled data-bs-toggle="tooltip"
                            title="You cannot add more content because you can only add 1 about us middle section">
                    ...
                    @else
                        <a href="{{ route('dashboard.about-us-middle-sections.create') }}" class="btn btn-primary" data-bs-toggle="tooltip"
                            title="">
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/about_us_middle_sections.js') }}"></script>
@endpush
