    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <div class="card-header d-flex align-items-center">
                <h3 class="fw-bolder text-dark">{{ __('Feature item data') . ' : ' . $aboutUsFeatureItem->title }}</h3>
            </div>
            <!-- end   :: Card header -->
            ...
            <div class="inputs-wrapper">
                ...
                <div class="row mb-10">
                    ...
                    <div class="col-md-12 fv-row d-flex justify-content-evenly">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <x-dashboard.upload-image-inp name="icon" :image="$aboutUsFeatureItem->getRawOriginal('icon')" directory="about-us-feature-items"
                ...
                <div class="row my-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="title_inp" name="title"
                                placeholder="example" value="{{ $aboutUsFeatureItem->title }}" readonly />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="about_us_feature_id_inp" name="about_us_feature_id"
                                placeholder="example" value="{{ $aboutUsFeatureItem->aboutUsFeature->title ?? 'N/A' }}" readonly />
                            <label for="about_us_feature_id_inp">{{ __('About us feature') }}</label>
                        </div>
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <textarea class="form-control form-control form-control" name="description" id="description_inp"
                            data-kt-autosize="true" readonly>{{ $aboutUsFeatureItem->description }}</textarea>
            ...
            <div class="form-footer">
                ...
                <!-- begin :: Submit btn -->
                <a href="{{ route('dashboard.about-us-feature-items.index') }}" class="btn btn-primary">
