...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.about-us-feature-items.update', $aboutUsFeatureItem->id) }}" class="form submitted-form" method="post"
                ...
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Edit feature item') . ' : ' . $aboutUsFeatureItem->title }}</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-12 fv-row d-flex justify-content-evenly">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <x-dashboard.upload-image-inp name="icon" :image="$aboutUsFeatureItem->getRawOriginal('icon')" directory="about-us-feature-items" placeholder="default.jpg" type="editable" ></x-dashboard.upload-image-inp>
                    ...
                    <div class="row my-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title"
                                    placeholder="example" value="{{ $aboutUsFeatureItem->title }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <select class="form-select" data-control="select2" name="about_us_feature_id" id="about_us_feature_id_inp" data-placeholder="{{ __("Choose the feature") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                    ...
                                    <option value="{{ $feature->id }}" {{ $aboutUsFeatureItem->about_us_feature_id == $feature->id ? 'selected' : '' }}>
                                        {{ $feature->title }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control form-control form-control" name="description" id="description_inp"
                                data-kt-autosize="true"> {{ $aboutUsFeatureItem->description }}</textarea>
