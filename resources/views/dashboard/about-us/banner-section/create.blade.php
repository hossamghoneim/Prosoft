    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <div class="card-header d-flex align-items-center">
                <h3 class="fw-bolder text-dark">{{ __('Add new banner section') }}</h3>
            </div>
            <!-- end   :: Card header -->

            <!-- begin :: Form -->
            <form class="form submitted-form" action="{{ route('dashboard.about-us-banner-sections.store') }}" method="post"
                    ...
                    <div class="row my-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" name="button_text"
                                value="{{ old('button_text') }}" placeholder="{{ __('Enter button text') }}" />
                            @error('button_text')
                                <div class="fv-plugins-message-container invalid-feedback">
                    ...
                    <div class="row my-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="text" class="form-control form-control-solid" name="button_url"
                                value="{{ old('button_url') }}" placeholder="{{ __('Enter button URL') }}" />
                            @error('button_url')
                                <div class="fv-plugins-message-container invalid-feedback">
