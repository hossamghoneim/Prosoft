            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        {{ __('About us final section item details') }}
                    </li>
                    <!-- end   :: Item -->
                </ul>
                <!-- end   :: Breadcrumb -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <div class="card-header d-flex align-items-center">
                <h3 class="fw-bolder text-dark">{{ __('About us final section item details') }}</h3>
            </div>
            <!-- end   :: Card header -->
            ...
            <div class="content-wrapper p-10">
                ...
                <div class="row my-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-control form-control-solid">
                            {{ $aboutUsFinalSectionItem->aboutUsFinalSection->title ?? 'N/A' }}
                        </div>
                    </div>
                    <!-- end   :: Column -->
                ...
                <div class="row my-10">
                    ...
                    <div class="col-md-12 fv-row">
                        ...
                        <div class="form-control form-control-solid">
                            {{ $aboutUsFinalSectionItem->description }}
                        </div>
                ...
                <div class="row my-10">
                    ...
                    <div class="col-md-4 fv-row">
                        ...
                        <div class="form-control form-control-solid">
                            @if($aboutUsFinalSectionItem->is_active)
                    ...
                    <div class="col-md-4 fv-row">
                        ...
                        <div class="form-control form-control-solid">
                            {{ $aboutUsFinalSectionItem->created_at }}
                        </div>
                    </div>
                    <!-- end   :: Column -->
