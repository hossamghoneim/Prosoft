...
@section('content')
    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Add Solution Middle Section Item') }}</h1>
                <!-- end   :: Title -->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!-- begin :: Item -->
                    <li class="breadcrumb-item text-muted">{{ __('Add new item') }}</li>
                    <!-- end   :: Item -->
                </ul>
                <!-- end   :: Breadcrumb -->
    ...
    <div class="card mb-2">
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.solution-middle-section-items.store') }}" class="form submitted-form" method="post"
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <select class="form-select form-select-solid" name="solution_middle_section_id" data-control="select2"
                            ...
                            @foreach($availableSections as $section)
                                <option value="{{ $section->id }}" {{ old('solution_middle_section_id') == $section->id ? 'selected' : '' }}>
                                    {{ $section->main_title }}
                                </option>
                            @endforeach
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <x-dashboard.upload-image-inp name="icon" image="null" :directory="null" placeholder="default.jpg" type="editable"></x-dashboard.upload-image-inp>
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <!-- begin :: Input -->
                        <input type="number" class="form-control form-control-solid" name="order" value="{{ old('order') }}"
