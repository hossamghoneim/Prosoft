...
@section('title', __('Solution Main Section Item Details'))
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        {{ __('Solution main section item details') }}
                    </li>
                    <!-- end   :: Item -->
                </ul>
                <!-- end   :: Breadcrumb -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <div class="card-header d-flex align-items-center">
                <h3 class="fw-bolder text-dark">{{ __('Solution main section item details') }}</h3>
            </div>
            <!-- end   :: Card header -->
            ...
            <div class="content-wrapper p-10">
                ...
                <div class="row my-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-control form-control-solid">
                            {{ $solutionMainSectionItem->solutionMainSection->title ?? 'N/A' }}
                        </div>
                    </div>
                    <!-- end   :: Column -->
                ...
                <div class="row my-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-control form-control-solid">
                            @if($solutionMainSectionItem->is_active)
                ...
                <div class="row my-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-control form-control-solid">
                            {{ $solutionMainSectionItem->created_at }}
                        </div>
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-control form-control-solid">
                            {{ $solutionMainSectionItem->updated_at }}
                        </div>
                    </div>
                    <!-- end   :: Column -->
