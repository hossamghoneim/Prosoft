    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Solution Main Section Items') }}</h1>
                <!-- end   :: Title -->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        {{ __('Solution main section items list') }}
                    </li>
                    <!-- end   :: Item -->
                </ul>
                <!-- end   :: Breadcrumb -->
            ...
            <table data-ordering="false" id="kt_datatable" class="table text-center table-row-dashed fs-6 gy-5">
                ...
                <thead>
                    <tr class="text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th>{{ __('Title') }}</th>
                        <th>{{ __('Order') }}</th>
                        <th>{{ __('Solution Main Section') }}</th>
                        <th>{{ __('is active') }}</th>
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/solution_main_section_items.js') }}"></script>
@endpush
