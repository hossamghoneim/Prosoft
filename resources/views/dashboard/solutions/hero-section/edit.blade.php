...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.solution-hero-sections.update', $solutionHeroSection->id) }}" class="form submitted-form" method="post"
                id="submitted-form" data-redirection-url="{{ route('dashboard.solution-hero-sections.index') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')

                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Edit solution hero') . ' : ' . $solutionHeroSection->title }}</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    <div class="row my-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <select class="form-select" name="solution_id" id="solution_id_inp" data-control="select2">
                                ...
                                @foreach($solutions as $solution)
                                    <option value="{{ $solution->id }}" {{ old('solution_id', $solutionHeroSection->solution_id) == $solution->id ? 'selected' : '' }}>
                                        {{ $solution->title }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title"
                                    placeholder="example" value="{{ old('title', $solutionHeroSection->title) }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="button_text_inp" name="button_text"
                                    placeholder="example" value="{{ old('button_text', $solutionHeroSection->button_text) }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="button_url_inp" name="button_url"
                                    placeholder="example" value="{{ old('button_url', $solutionHeroSection->button_url) }}" />
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <textarea class="form-control form-control form-control" name="description" id="description_inp"
                                data-kt-autosize="true">{{ old('description', $solutionHeroSection->description) }}</textarea>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <input type="file" class="form-control" id="video_url_inp" accept="video/*" name="video_url" />
                            @if($solutionHeroSection->video_url)
                                <small class="form-text text-muted">{{ __('Current video:') }} {{ basename($solutionHeroSection->video_url) }}</small>
                            @endif
