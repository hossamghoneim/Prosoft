                            ...
                            <div class="row g-6">
                                ...
                                <div class="col-md-4 fv-row">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <x-dashboard.upload-image-inp name="first_card_icon" image="null" :directory="null"
                                ...
                                <div class="col-md-4 fv-row">
                                    ...
                                    <textarea class="form-control form-control-lg" name="first_card_description" id="first_card_description_inp"
                                        placeholder="Enter the first card description" rows="3"></textarea>
                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="row g-6">
                                ...
                                <div class="col-md-4 fv-row">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <x-dashboard.upload-image-inp name="second_card_icon" image="null" :directory="null"
                                            placeholder="default.jpg" type="editable"></x-dashboard.upload-image-inp>
                                    </div>
                                ...
                                <div class="col-md-4 fv-row">
                                    ...
                                    <textarea class="form-control form-control-lg" name="second_card_description" id="second_card_description_inp"
                                        placeholder="Enter the second card description" rows="3"></textarea>
                        ...
                        <div class="card-body p-6">
                            ...
                            <div class="row g-6">
                                ...
                                <div class="col-md-4 fv-row">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <x-dashboard.upload-image-inp name="third_card_icon" image="null" :directory="null"
                                            placeholder="default.jpg" type="editable"></x-dashboard.upload-image-inp>
                                    </div>
                                ...
                                <div class="col-md-4 fv-row">
                                    ...
                                    <textarea class="form-control form-control-lg" name="third_card_description" id="third_card_description_inp"
                                        placeholder="Enter the third card description" rows="3"></textarea>
