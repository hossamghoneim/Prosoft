    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <div class="card-header d-flex align-items-center">
                <h3 class="fw-bolder text-dark">{{ __('banner data') . ' : ' . $serviceBannerSection->title }}</h3>
            </div>
            <!-- end   :: Card header -->
                ...
                <div class="row mb-10">
                    ...
                    <div class="col-md-12 fv-row d-flex justify-content-evenly">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <x-dashboard.upload-image-inp name="image" :image="$serviceBannerSection->getRawOriginal('image')" directory="BannerImages"
                ...
                <div class="row my-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="title_inp" name="title"
                                placeholder="example" value="{{ $serviceBannerSection->title }}" readonly />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <textarea class="form-control form-control form-control" name="description" id="description_inp"
                            data-kt-autosize="true" readonly>{{ $serviceBannerSection->description }}</textarea>
            ...
            <div class="form-footer">
                ...
                <!-- begin :: Submit btn -->
                <a href="{{ route('dashboard.service-banner-sections.index') }}" class="btn btn-primary">
