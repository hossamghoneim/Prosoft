                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-12 fv-row d-flex justify-content-evenly">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <x-dashboard.upload-image-inp name="image" :image="$serviceBannerSection->getRawOriginal('image')" directory="BannerImages" placeholder="default.jpg" type="editable" ></x-dashboard.upload-image-inp>
