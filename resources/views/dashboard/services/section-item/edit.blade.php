...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.service-section-items.update', $serviceSectionItem->id) }}" class="form submitted-form" method="post"
                id="submitted-form" data-redirection-url="{{ route('dashboard.service-section-items.index') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')

                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Edit item') . ' : ' . $serviceSectionItem->title }}</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row my-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title"
                                    placeholder="example" value="{{ $serviceSectionItem->title }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <select class="form-select" data-control="select2" name="service_section_id" id="service_section_id_inp" data-placeholder="{{ __("Choose the service") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                    @foreach($availableSections as $section)
                                    <option value="{{ $section->id }}" {{ $serviceSectionItem->service_section_id == $section->id ? 'selected' : '' }}>
                                        {{ $section->title }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control form-control form-control" name="description" id="description_inp"
                                data-kt-autosize="true"> {{ $serviceSectionItem->description }}</textarea>
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="form-floating">
                                    <input type="number" class="form-control" id="order_inp" name="order"
                                        placeholder="1" min="1" value="{{ $serviceSectionItem->order }}" />
