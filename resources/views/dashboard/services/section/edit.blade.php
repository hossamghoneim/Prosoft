...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.service-sections.update', $serviceSection->id) }}" class="form submitted-form" method="post"
                ...
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Edit section') . ' : ' . $serviceSection->title }}</h3>
                </div>
                <!-- end   :: Card header -->
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title"
                                    placeholder="example" value="{{ $serviceSection->title }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="slug_inp" name="slug"
                                    placeholder="example" value="{{ $serviceSection->slug }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="number" class="form-control" id="order_inp" name="order"
                                    placeholder="1" min="1" value="{{ $serviceSection->order }}" />
