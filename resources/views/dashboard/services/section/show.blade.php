    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <div class="card-header d-flex align-items-center">
                <h3 class="fw-bolder text-dark">{{ __('section data') . ' : ' . $serviceSection->title }}</h3>
            </div>
            <!-- end   :: Card header -->
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="title_inp" name="title"
                                placeholder="example" value="{{ $serviceSection->title }}" readonly />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="slug_inp" name="slug"
                                placeholder="example" value="{{ $serviceSection->slug }}" readonly />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-floating">
                            <input type="number" class="form-control" id="order_inp" name="order"
                                placeholder="1" min="1" value="{{ $serviceSection->order }}" readonly />
            ...
            <div class="form-footer">
                ...
                <!-- begin :: Submit btn -->
                <a href="{{ route('dashboard.service-sections.index') }}" class="btn btn-primary">
