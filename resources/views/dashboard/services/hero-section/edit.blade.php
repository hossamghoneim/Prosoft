...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.service-hero-sections.update', $serviceHeroSection->id) }}" class="form submitted-form" method="post"
                id="submitted-form" data-redirection-url="{{ route('dashboard.service-hero-sections.index') }}">
                @csrf
                @method('PUT')

                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Edit hero') . ' : ' . $serviceHeroSection->name }}</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    {{-- <div class="row mb-10">
                        ...
                        <div class="col-md-12 fv-row d-flex justify-content-evenly">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <x-dashboard.upload-image-inp name="image" :image="$serviceHeroSection->getRawOriginal('image')" directory="Brands" placeholder="default.jpg" type="editable" ></x-dashboard.upload-image-inp>
                    ...
                    <div class="row my-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title"
                                    placeholder="example" value="{{ $serviceHeroSection->title }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="button_text_inp" name="button_text"
                                    placeholder="example" value="{{ $serviceHeroSection->button_text }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control form-control form-control" name="description" id="description_inp"
                                data-kt-autosize="true"> {{ $serviceHeroSection->description }}</textarea>
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="button_url_inp" name="button_url"
                                        placeholder="example" value="{{ $serviceHeroSection->button_url }}" />
