    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Partner Banner Section Items') }}</h1>
                <!-- end   :: Title -->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <li class="breadcrumb-item text-muted">
                        {{ __('Partner banner section items list') }}
                    </li>
                    <!-- end   :: Item -->
                </ul>
                <!-- end   :: Breadcrumb -->
        ...
        <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
            ...
            <div class="d-flex flex-stack flex-wrap mb-15">
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    @if($canAddMore)
                        <a href="{{ route('dashboard.partner-banner-section-items.create') }}" class="btn btn-primary" data-bs-toggle="tooltip"
                            title="">
                    ...
                    @else
                        <button class="btn btn-secondary" disabled data-bs-toggle="tooltip"
                            title="You cannot add more items because all partner banner sections have reached the limit of 3 items">
            ...
            <table data-ordering="false" id="kt_datatable" class="table text-center table-row-dashed fs-6 gy-5">
                ...
                <thead>
                    <tr class="text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                        ...
                        <th>{{ __('Partner Banner Section') }}</th>
                        <th>{{ __('is active') }}</th>
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/partner_banner_section_items.js') }}"></script>
@endpush
