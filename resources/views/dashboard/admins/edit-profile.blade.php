    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="tab-content" id="pills-tab-content" >
            ...
            <div class="tab-pane fade show active" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                <form action="{{ route('dashboard.update-profile') }}" class="submitted-form" method="post" data-redirection-url="#" data-success-message="{{ __('Your Profile has been updated successfully') }}">
                    @csrf
                    @method('PUT')
                    <!--begin::Card body-->
                    <div class="card-body  p-9">
                        ...
                        <div class="row mb-6">
                            <label class="col-lg-2 required fs-6 fw-bold mb-2 d-flex align-items-center">{{ __("Name") }}</label>

                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="name_inp" name="name" placeholder="full name" value="{{ auth()->user()->name }}" />
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="phone_inp" name="phone" placeholder="phone number" value="{{ auth()->user()->phone }}"/>
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-10">
                                <input type="text" class="form-control" id="email_inp" name="email" placeholder="email address" value="{{ auth()->user()->email }}"/>
            ...
            <div class="tab-pane fade" id="pills-password" role="tabpanel" aria-labelledby="pills-password-tab">
                <form action="{{ route('dashboard.update-password') }}" class="submitted-form" method="post" data-redirection-url="#" data-success-message="{{ __('Your Password has been updated successfully') }}">
                    @csrf
                    @method('PUT')
                    <!--begin::Card body-->
                    <div class="card-body  p-9">
                        ...
                        <!--begin::Input group-->
                        <div class="row mb-6">
                            <label class="col-lg-2 required fs-6 fw-bold mb-2  d-flex align-items-center">{{ __("Password") }}</label>
