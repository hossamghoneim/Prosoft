...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.admins.store') }}" class="form submitted-form" autocomplete="off" method="post"  data-redirection-url="{{ route('dashboard.admins.index') }}">
            @csrf
            <!-- begin :: Card header -->
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="d-flex flex-column align-items-center gap-6 justify-content-center text-center mt-4 mb-10">
                        <!--begin::Image input-->
                        <x-dashboard.upload-image-inp name="image" :image="null"  placeholder="default.svg" type="editable"></x-dashboard.upload-image-inp>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <label class="fs-6 fw-bold mb-2">{{ __("Role") }}</label>
                            <select class="form-select" data-control="select2" name="role_id" id="role_id_inp" data-placeholder="{{ __("Choose the role") }}" data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                <option></option>
                            ...
                            <p class="invalid-feedback" id="role_id" ></p>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <label class="fs-6 fw-bold mb-2">{{ __("Password") }}</label>
                            <div class="form-floating">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <label class="fs-6 fw-bold mb-2">{{ __("Password confirmation") }}</label>
                            <div class="form-floating">
