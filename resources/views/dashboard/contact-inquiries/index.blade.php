    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Contact Inquiries') }}</h1>
                <!-- end   :: Title -->
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/contact_inquiries.js') }}"></script>
@endpush
