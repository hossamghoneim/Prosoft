    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            ...
            <div class="card-header d-flex align-items-center">
                <h3 class="fw-bolder text-dark">{{ __('Contact us content details') }}</h3>
            </div>
            <!-- end   :: Card header -->
            ...
            <div class="content-wrapper p-10">
                ...
                <div class="row my-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-control form-control-solid">
                            {{ $contactUsContent->contact_email }}
                        </div>
                    </div>
                    <!-- end   :: Column -->
                ...
                <div class="row my-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <div class="form-control form-control-solid">
                            {{ $contactUsContent->contact_phone }}
                        </div>
