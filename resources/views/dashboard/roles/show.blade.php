            ...
            <div class="card card-flush">
                ...
                <div class="card-body pb-2" style="height:500px !important;overflow-y: auto">
                    ...
                    <div class="d-flex flex-column text-gray-600">
                        ...
                        @foreach( collect($role->permissions) as $module => $modulePermissions)

                            @foreach($modulePermissions as $permission)
                                <div class="d-flex align-items-center py-2">
                                    <span class="bullet bg-primary me-3"></span> {{ __( str_replace("_", " " , $permission) ) . ' ' . __( str_replace("_", " " ,$module) ) }}
                                </div>
                            @endforeach
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body scroll-y mx-5 my-7">
                            ...
                            <form id="role_form_update" data-form-type="update"
                                  class="form fv-plugins-bootstrap5 fv-plugins-framework submitted-form" method="POST"
                                  data-redirection-url="#" data-trailing="_edit">
                                @csrf
                                @method('PUT')
                                <!--begin::Scroll-->
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_role_scroll"
                                     ...
                                     data-kt-scroll-offset="300px" style="max-height: 637px;">
                                    <!--begin::Input group-->
                                                                ...
                                                                <div class="d-flex">
                                                                    @foreach($modulePermissions as $permission)
                                                                        ...
                                                                        <label class="form-check form-check-sm form-check-custom form-check-solid">
                                                                            <input class="form-check-input update-checkbox"
                                                                                   type="checkbox"
                                                                                   id="update_{{$permission}}_{{$module}}"
                                                                                   data-module="{{$module}}"
