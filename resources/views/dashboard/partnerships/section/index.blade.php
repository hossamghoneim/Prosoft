    ...
    <div class="toolbar">
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!-- begin :: Title -->
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">{{ __('Partnership Section') }}</h1>
                <!-- end   :: Title -->
                ...
                <div class="d-flex justify-content-end" data-kt-docs-table-toolbar="base">
                    ...
                    @if($existingSection)
                        <button class="btn btn-secondary" disabled data-bs-toggle="tooltip"
                            title="You cannot add more content because you can only add 1 partnership section">
                    ...
                    @else
                        <a href="{{ route('dashboard.partnership-sections.create') }}" class="btn btn-primary" data-bs-toggle="tooltip"
                            title="">
...
@push('scripts')
    ...
    <script src="{{ asset('js/dashboard/datatables/partnership_sections.js') }}"></script>
@endpush
