...
@section('content')
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a
                        href="{{ route('dashboard.partnership-hero-sections.index') }}"
                        class="text-muted text-hover-primary">{{ __('Partnership Hero') }}</a></h1>
                <!-- end   :: Title -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.partnership-hero-sections.update', $partnershipHeroSection->id) }}" class="form submitted-form" method="post"
                id="submitted-form" data-redirection-url="{{ route('dashboard.partnership-hero-sections.index') }}">
                @csrf
                @method('PUT')

                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Edit partnership hero') . ' : ' . $partnershipHeroSection->title }}</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    <div class="row my-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title"
                                    placeholder="example" value="{{ $partnershipHeroSection->title }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="button_text_inp" name="button_text"
                                    placeholder="example" value="{{ $partnershipHeroSection->button_text }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <textarea class="form-control form-control form-control" name="description" id="description_inp"
                                data-kt-autosize="true"> {{ $partnershipHeroSection->description }}</textarea>
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="button_url_inp" name="button_url"
                                        placeholder="example" value="{{ $partnershipHeroSection->button_url }}" />
