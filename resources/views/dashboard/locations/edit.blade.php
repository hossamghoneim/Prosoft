...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.locations.update', $location->id) }}" class="form submitted-form" method="post"
                ...
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Edit location') . ' : ' . $location->title }}</h3>
                </div>
                <!-- end   :: Card header -->
                    ...
                    <div class="row my-10">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="title_inp" name="title"
                                    placeholder="example" value="{{ $location->title }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="number" class="form-control" id="order_inp" name="order"
                                    placeholder="1" min="1" value="{{ $location->order }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="number" step="any" class="form-control" id="latitude_inp" name="latitude"
                                    placeholder="30.0787215" value="{{ $location->latitude }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="number" step="any" class="form-control" id="longitude_inp" name="longitude"
                                    placeholder="30.9996055" value="{{ $location->longitude }}" />
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <textarea class="form-control form-control form-control" name="address" id="address_inp"
                                data-kt-autosize="true" rows="3">{{ $location->address }}</textarea>
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <textarea class="form-control form-control form-control" name="iframe_url" id="iframe_url_inp"
                                data-kt-autosize="true" rows="3">{{ $location->iframe_url }}</textarea>
