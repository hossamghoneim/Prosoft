            ...
            <div class="content-wrapper p-10">
                ...
                <div class="row my-10">
                    ...
                    <div class="col-md-12 fv-row">
                        ...
                        <div class="form-control form-control-solid">
                            {!! nl2br(e($homeHeroSection->description)) !!}
                        </div>
                    ...
                    <div class="col-md-12 fv-row">
                        ...
                        <div class="border rounded p-0" style="width: 100%; height: 400px; overflow: hidden; position: relative;">
                            <div style="width: 100%; height: 100%;">
                                @if($homeHeroSection->video_url)
                                    <video controls style="width: 100%; height: 100%; object-fit: cover;">
                                        <source src="{{ getFilePath($homeHeroSection->video_url) }}" type="video/mp4">
                                        <source src="{{ getFilePath($homeHeroSection->video_url) }}" type="video/webm">
