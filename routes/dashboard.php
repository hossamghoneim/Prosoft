...
use App\Http\Controllers\Dashboard\SolutionMiddleSectionItemController;
...
Route::resource('solution-main-section-item-contents', SolutionMainSectionItemContentController::class)->parameters(['solution-main-section-item-contents' => 'content']);
    ...
    Route::get('solution-middle-section-items/check-exists', [SolutionMiddleSectionItemController::class, 'checkExists'])->name('solution-middle-section-items.check-exists');
    Route::resource('solution-middle-section-items',SolutionMiddleSectionItemController::class);
