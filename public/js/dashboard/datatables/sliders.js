        ...
        datatable = $("#kt_datatable").DataTable({
            ...
            ajax: {
                data: function () {
                    ...
                    datatable.DataTable().ajax.url(`/sliders?page=${info.page + 1}&per_page=${info.length}`);
                }
            },
            columns: [
                {data: 'id'},
            ...
            columnDefs: [
                {
                    targets: 2,
                    data: null,
                    render: (data, type, row) => data ?? '<h1>-</h1>'
                },
                {
                    targets: -1,
                    data: null,
                        ...
                        return `
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="/sliders/${ row.id }/edit" class="menu-link px-3 d-flex justify-content-between edit-row" >
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        return `<a class="d-block overlay" style="height:50px;" data-fslightbox="lightbox-basic" href="${getFilePath( data)}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded"
                                         style="height:56px;width:150px;border-radius:4px;margin:auto;background-image:url('${getFilePath(data)}');background-size:contain;">
                                    </div>
                                    <!--end::Image-->
                                    <!--begin::Action-->
